...
# Or Access an exisiting one

#If the user would like to create a new account, accept their name and initial deposit
# And create a 5 digit random number & make it as the account number of new Saving Account

# If they are accessing an exisiting account, accept their name and account number to validate the user
# Give them the option of withdraw, deposit or display their available balance
